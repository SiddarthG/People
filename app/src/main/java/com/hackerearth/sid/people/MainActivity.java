...
public class MainActivity extends AppCompatActivity {
    ...
    public void sort(String category){
        if(category.equals("All")){
            ...
            listF.clear();
            for (DataSet a : list) {
                if (a.ethnicity.equals(category)) {
                    listF.add(a);
        ...
        try {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(url, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        articles = response.getJSONArray("members");
                    ...
                    for (int i = 0; i < articles.length(); i++) {
                        ...
                        try {
                            ...
                            Date dob = dateformat.parse(obj.getString("dob"));
                            String status = obj.getString("status");
                            String image=obj.getString("image");
                            int ethnicity=obj.getInt("ethnicity");
                           int weight=obj.getInt("weight");
                            int height=obj.getInt("height");
                            boolean is_veg=(1==obj.getInt("is_veg"));
                            boolean drink=(1==obj.getInt("drink"));

                            DataSet object = new DataSet(dob,status, image,ethnicity,weight,height,is_veg,drink);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> sAdapter=ArrayAdapter.createFromResource(this,R.array.ethnicity,android.R.layout.simple_spinner_dropdown_item);
